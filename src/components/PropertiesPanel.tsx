...
export function PropertiesPanel({ selectedNode, selectedEdge, onUpdateNode, onUpdateEdge }: PropertiesPanelProps) {
  ...
  if (!selectedNode && !selectedEdge) {
    return (
      <div className="w-80 bg-white border-l border-gray-300 p-4 h-[800px] flex items-center justify-center text-gray-400">
  ...
  if (selectedEdge && !selectedNode) {
    ...
    return (
      <div className="w-80 bg-white border-l border-gray-300 p-4 overflow-y-auto h-[800px]">
